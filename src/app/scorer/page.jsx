      ...
      <div style={{ flex: 1, display: "flex", overflow: "hidden" }}>
        ...
        <main style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
          {(mode === "coreweave" || persona) && <div style={{ padding: "14px 24px", borderBottom: "1px solid #E5E7EB", display: "flex", alignItems: "center", gap: 14, background: "#fff", flexShrink: 0 }}>
            {mode === "coreweave" ? <>
              <div style={{ width: 38, height: 38, borderRadius: 10, background: "#0D111718", border: "1.5px solid #00C2FF40", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}><svg width="16" height="16" viewBox="0 0 16 16" fill="none"><path d="M8 1L14 4.5V11.5L8 15L2 11.5V4.5L8 1Z" stroke={CW_BLUE} strokeWidth="1.2" fill="none"/><path d="M8 4L11 5.75V9.25L8 11L5 9.25V5.75L8 4Z" fill={CW_BLUE} opacity="0.3"/></svg></div>
          ...
          {(mode === "coreweave" || persona) && <div style={{ borderTop: "1px solid #E5E7EB", padding: "16px 24px", background: "#fff", flexShrink: 0 }}>
            ...
            <textarea value={pitch} onChange={e => setPitch(e.target.value)} placeholder={mode === "coreweave" ? "Paste any pitch, email, talk track, or cold outreach to score against CoreWeave GTM framework..." : `Paste your pitch, email, or message for ${persona?.name}...`} style={{ width: "100%", background: "#F9FAFB", border: "1px solid #E5E7EB", borderRadius: 10, padding: "12px 14px", fontSize: 13, color: "#111827", fontFamily: "inherit", resize: "none", outline: "none", lineHeight: 1.6 }} rows={4} onFocus={e => e.target.style.borderColor = accent} onBlur={e => e.target.style.borderColor = "#E5E7EB"} />
