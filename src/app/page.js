        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Link href="/scorer" style={{ textDecoration: "none" }}>
            <div style={{ background: "var(--navy-2)", border: "1px solid var(--border)", borderRadius: 16, padding: "32px", cursor: "pointer", height: "100%", display: "flex", flexDirection: "column" }}
              ...
              <div style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.65, marginBottom: 28, flex: 1 }}>Paste any message, email, or pitch. Get a resonance score, gut reaction, what's missing, and a suggested rewrite — from your buyer's point of view. Supports W&B personas and CoreWeave GTM scoring.</div>
      ...
      <section style={{ padding: "0 40px 80px", maxWidth: 860, margin: "0 auto", width: "100%" }}>
        <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: 40 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 40 }}>
            {[
              { n: "01", title: "Pick your mode", body: "W&B mode: choose a persona — Malik, Diana, Carter, Paul, or Sonia — and score against their triggers and red flags. CoreWeave mode: score any pitch against the GTM framework." },
