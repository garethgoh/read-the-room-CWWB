    ...
    <main style={{ minHeight: "100vh", background: "var(--navy)", display: "flex", flexDirection: "column" }}>
      <nav style={{ borderBottom: "1px solid var(--border-light)", padding: "0 40px", height: 52, display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          <img src="/coreweave-logo.png" style={{ height: 18, filter: "brightness(0) invert(1)" }} alt="CoreWeave" />
      ...
      <section style={{ padding: "80px 40px 56px", maxWidth: 860, margin: "0 auto", width: "100%" }}>
        ...
        <p style={{ fontSize: 16, color: "var(--text-secondary)", lineHeight: 1.65, maxWidth: 520, margin: "0 0 32px" }}>
          Score any marketing message or sales pitch against real buyer personas. Roleplay the conversation before you're actually in the room.
        </p>
        <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
          <span style={{ fontSize: 11, color: "var(--text-tertiary)" }}>Powered by</span>
          <img src="/coreweave-logo.png" style={{ height: 16, filter: "brightness(0) invert(1) opacity(0.6)" }} alt="CoreWeave" />
          <span style={{ fontSize: 11, color: "var(--text-tertiary)" }}>+</span>
          <img src="/wb-logo.png" style={{ height: 16, filter: "brightness(0) invert(1) opacity(0.6)" }} alt="W&B" />
        </div>
      </section>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14 }}>
          <Link href="/scorer" style={{ textDecoration: "none" }}>
            <div style={{ background: "var(--navy-2)", border: "1px solid var(--border)", borderRadius: 16, padding: "32px", cursor: "pointer", height: "100%", display: "flex", flexDirection: "column" }}
              ...
              <div style={{ fontSize: 14, color: "var(--text-secondary)", lineHeight: 1.65, marginBottom: 28, flex: 1 }}>Paste any message, email, or pitch. Get a resonance score, gut reaction, what's missing, and a suggested rewrite — from your buyer's point of view.</div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <img src="/coreweave-logo.png" style={{ height: 12, filter: "brightness(0) invert(1) opacity(0.4)" }} alt="CoreWeave" />
                <span style={{ fontSize: 10, color: "var(--text-tertiary)" }}>+</span>
                <img src="/wb-logo.png" style={{ height: 12, filte
cat > ~/read-the-room/src/app/page.js << 'ENDOFFILE'
"use client"
import Link from "next/link"
  ...
  return (
    <main style={{ minHeight: "100vh", background: "var(--navy)", display: "flex", flexDirection: "column" }}>
          ...
          <Link href="/scorer" style={{ textDecoration: "none" }}>
            <div style={{ background: "var(--navy-2)", border: "1px solid var(--border)", borderRadius: 16, padding: "32px", cursor: "pointer", height: "100%", display: "flex", flexDirection: "column" }}
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                <img src="/coreweave-logo.png" style={{ height: 12, filter: "brightness(0) invert(1) opacity(0.4)" }} alt="CoreWeave" />
                <span style={{ fontSize: 10, color: "var(--text-tertiary)" }}>+</span>
                <img src="/wb-logo.png" style={{ height: 12, filter: "brightness(0) invert(1) opacity(0.4)" }} alt="W&B" />
              </div>
            </div>
          </Link>
      ...
      <section style={{ padding: "0 40px 80px", maxWidth: 860, margin: "0 auto", width: "100%" }}>
        <div style={{ borderTop: "1px solid var(--border-light)", paddingTop: 40 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 40 }}>
            {[
              { n: "01", title: "Pick your mode", body: "W&B mode: choose a persona — Carter, Malik, Diana, Paul, or Sonia. CoreWeave mode: choose from Cedric, Carter, Alice, or Paul. Each has real triggers, red flags, and proof points." },
      ...
      <div style={{ borderTop: "1px solid var(--border-light)", padding: "16px 40px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
        <img src="/wb-logo.png" style={{ height: 14, filter: "brightness(0) invert(1) opacity(0.4)" }} alt="W&B" />
        <img src="/coreweave-logo.png" style={{ height: 14, filter: "brightness(0) invert(1) opacity(0.4)" }} alt="CoreWeave" />
      </div>
    </main>
  )
}
